...
\begin{tabular*}{7in}{l@{\extracolsep{\fill}}r}
    ...
    %{\footnotesize \texttt{\colorbox{yellow}{[web version:  address \& phone omitted]} }} & {\href{http://charles.greene.one}{http://charles.greene.one}} \\
    {\footnotesize \texttt{Phone: (902) 798-7320}} & {\href{http://charles.greene.one}{http://charles.greene.one}} \\
...
\resheading{Personal Profile} %{{{1
    \begin{itemize}
        \item[] I am a Software Developer specializing in Roku Channels and Ruby on Rails Development. I have four years of experience in my field preforming as a developer. I enjoy developing
          developing software for web or set top box. I am a quick learner able to pick up new languages and frameworks easily. I am self motivated so I am able to works with minimal
          direction but have lots of experience working on teams, both as a leader and a follower. These attributes will make me a asset to any team.
    \end{itemize}
%}}}
...
\resheading{{Skills}} %{{{1
    \begin{itemize}
        \item Skilled developer of Roku channels
        \item Expert programmer of Ruby on Rails applications
...
\newpage
\mywebheader
\resheading{Relevant Work Experience} %{{{1
    \begin{itemize}
        \item[]
            \ressubheading{REDspace}{Bedford, NS}{Senior Web Developer}{December 2014 - Present}
                \begin{itemize}
                    \resitem{Maintain and assist in development of the Viacom Roku Channels and other emerging playform apps}
                    \begin{itemize}
                      \resitem{Brightscript}
                      \resitem{Ruby}
                      \resitem{Git}
                      \resitem{Java}
                      \resitem{Javascript}
                      \resitem{Android Development}
                    \end{itemize}
                \end{itemize}
        \item[]
            \ressubheading{Colibri Software}{Wolfville, NS}{Software Developer}{April 2012 - December 2014}
                \begin{itemize}
                ...
                \end{itemize}
        \item[]
            \ressubheading{Ooka Island}{Charlottetown, PE}{Software Developer}{Sept 2014 - November 2014}
                \begin{itemize}
...
\begin{comment}
        \item[]
            \ressubheading{76 Minas Sea Cadets (DND)}{Windsor, NS}{Administration Officer}{Sept. 2014 - Present}
                ...
                \end{itemize}
        \item[]
            \ressubheading{76 Minas Sea Cadets (DND)}{Windsor, NS}{Training Officer}{Sept. 2010 - Sept. 2014}
                \begin{itemize}
        ...
        \item[]
            \ressubheading{Jodrey School of Computer Science}{Wolfville, NS}{Computer Science Lab Consultant}{Jan. 2010 - Aug. 2010}
                ...
                \end{itemize}
        \item[]
            \ressubheading{76 Minas Sea Cadets (DND)}{Windsor, NS}{Administration Officer}{Mar. 2007 - Aug. 2010}
                \begin{itemize}
                    \resitem{Employed organization skills in maintaining online database of cadet documentation to ensure easy and consistent transfer of data
                    between units and headquarters}
                    \resitem{Create and maintain paper documentation on every cadet to enter the unit}
...
\resheading{References} %{{{1
    \begin{center}
        \begin{tabular*}{1\textwidth}{@{\extracolsep{\fill}}  l l l }
            John Read & Darcy Benoit & Jim Diamond \\
            CEO & Computer Science & Computer Science \\
            \vspace{10pt}
            Colibri Software & Acadia University & Acadia University \\
            24 University & 27 University Ave. & 27 University Ave. \\
            Wolfville NS & Wolfville NS & Wolfville NS \\
            (902) 704-0243 & (902) 585-1390 & (902) 585-1402 \\
        \end{tabular*}
    \end{center}
%\end{document}
%}}}
